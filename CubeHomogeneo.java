...
public class CubeHomogeneo implements GLEventListener {
    ...
    public static void main(String[] args) {
        ...
        canvas.addGLEventListener(new CubeHomogeneo());
        frame.add(canvas);
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        gl.glBegin(GL.GL_QUADS);//DERECHA
            gl.glColor3f(0.0f, 0.5f, 0.5f);    // Set the current drawing color to light blue
